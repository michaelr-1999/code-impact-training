...
export async function createTask(data: { title: string; description?: string; dueDate?: string }): Promise<ApiTask> {
...
export async function updateTask(id: string, data: { title?: string; description?: string | null; dueDate?: string | null; completedAt?: string | null }): Promise<ApiTask> {
